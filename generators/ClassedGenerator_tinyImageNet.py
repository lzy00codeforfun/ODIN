...
class ClassedGenerator_tinyImageNet:
    ...
    def setup(self, datacrawler, mode = "train", batch_size=32, workers = 8, preload_classes = []):
        ...
        elif datacrawler == "tinyImageNet":
            from .TinyImageNet import TinyImageNet
            self.__dataset = TinyImageNet(root="/w/247/zyanliu/ImageNet/tiny-imagenet-200", split=mode, transform = self.transformer)
        else:
